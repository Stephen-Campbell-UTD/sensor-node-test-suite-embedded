...
/* Object__DESC__C */
#ifndef ti_sysbios_heaps_HeapTrack_Object__DESC__CR
extern __FAR__ const xdc_runtime_Core_ObjDesc ti_sysbios_heaps_HeapTrack_Object__DESC__C;
#else
#define ti_sysbios_heaps_HeapTrack_Object__DESC__C (*((xdc_runtime_Core_ObjDesc*)(xdcRomConstPtr + ti_sysbios_heaps_HeapTrack_Object__DESC__C_offset)))
#endif

/* Object__PARAMS__C */
#ifndef ti_sysbios_heaps_HeapTrack_Object__PARAMS__CR
extern __FAR__ const ti_sysbios_heaps_HeapTrack_Params ti_sysbios_heaps_HeapTrack_Object__PARAMS__C;
#else
#define ti_sysbios_heaps_HeapTrack_Object__PARAMS__C (*((ti_sysbios_heaps_HeapTrack_Params*)(xdcRomConstPtr + ti_sysbios_heaps_HeapTrack_Object__PARAMS__C_offset)))
#endif
...
{
    xdc_runtime_Types_InstHdr *iHdr = (xdc_runtime_Types_InstHdr *)ti_sysbios_heaps_HeapTrack_Object__DESC__C.modLink->next;

    if (iHdr != (xdc_runtime_Types_InstHdr *)ti_sysbios_heaps_HeapTrack_Object__DESC__C.modLink) {
        return iHdr + 1;
    }
    else {
        return NULL;
...
xdc_Ptr ti_sysbios_heaps_HeapTrack_Object__next__S( xdc_Ptr obj )
{
    ...
    if (iHdr->link.next != (xdc_runtime_Types_Link *)ti_sysbios_heaps_HeapTrack_Object__DESC__C.modLink) {
